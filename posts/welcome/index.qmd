...
India has 28 states and 8 union territories. States enjoy a more autonomy, managing local governance, education, health, and law enforcement, while union territories are typically governed by the central government. Some union territories, like Delhi and Puducherry, have partial statehood, allowing them to have their own legislatures with limited authority. 
...
#| echo: FALSE
#| label: tbl-one
#| tbl-cap: "Highest Literacy rates in Urban and Rural region of India"

# Creating a table showcasing top 10 states/union territories with highest rates
top_10 <- data %>%
  ...
  arrange(desc(`Literacy Rate (Persons) - Rural - 2011`), desc(`Literacy Rate (Persons) - Urban - 2011`)) |>
  slice_head(n = 10)

# Using kable to create the table 
kable(top_10, caption = "Top 10 States/Union Territories with Highest Rural and Urban Literacy Rates (2011 vs 2001)")
